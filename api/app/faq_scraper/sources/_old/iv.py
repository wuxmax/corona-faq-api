...
source_id = "iv"
source_name = "dainas.aot.tu-berlin.de"
root_url = "http://dainas.aot.tu-berlin.de"
source_url = root_url + "/~andreas@dai/20200331__BerlinCorona/FAQZurAusgangsbeschraenkung.html"
...
def get_faq():
    ...
    for div in faq_box_[1:]:
        ...
        if len(b_size) == 2:
            ...
            faq["src_url"]: str = "https://www.berlin.de/corona"
            faq["src_name"]: str = "berlin.de"
